            ...
            <form name="admin" action="Controller" method="post">
                <nav id="links"> 
                    <ul>                                             
                        ...
                        <li> <a href="admin_view_all.jsp" title="Insert" > <img id="view"  border="0" src="Images/view.png" width="75" height="75" alt="Loading" /> </a> </li>
                        <li> <a href="admin_insert.jsp" title="Insert" > <img id="insert"  border="0" src="Images/insert1.jpg" width="75" height="25" alt="Loading" /> </a> </li>
                    </ul>
                </nav>
