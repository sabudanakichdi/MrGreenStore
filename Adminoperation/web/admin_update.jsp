<%-- 
    Document   : admin
    Created on : Oct 24, 2016, 1:00:10 PM
    Author     : green
--%>
    ...
    <body>
        ...
        <div id="big_wrapper">            
            ...
            <form name="admin" action="Controller" method="post">
                ...
                <nav id="links"> 
                    <ul>                        
                        <li> <a href="admin_insert.jsp" title="Insert" > <img id="insert"  border="0" src="Images/insert1.jpg" width="25" height="25" alt="Loading" /> </a> </li>                        
                        ...
                        <li> <a href="admin_update.jsp" title="Update" > <img id="update"  border="0" src="Images/update.png" width="75" height="75" alt="Loading" /> </a> </li>
                ...
                <center>      <br /><h3> Select a product to update </h3> <br />  <br /> 
                    ...
                    <select name="admin_classifer_choice">
                        <option value=""> </option>
                        <option value="Vegetbables"> product </option> 
